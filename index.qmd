...
pop_by_tract_type <- j40_dw %>% 
  ...
  summarise(population = sum(TPF,na.rm=TRUE)) 

pop_by_tract_type <- pop_by_tract_type %>%
  mutate(category = case_when(
    dw_disadv_ut1 & CEJST_disadv == "CEJST disadvantaged"  ~ "DW violation + CEJST",
    !dw_disadv_ut1 & CEJST_disadv == "CEJST disadvantaged"  ~ "No DW violation + CEJST",
    !dw_disadv_ut1 & CEJST_disadv == "Not CEJST disadvantaged"  ~ "No DW violation + Not CEJST",
    dw_disadv_ut1 & CEJST_disadv == "Not CEJST disadvantaged"  ~ "DW violation + Not CEJST"
  )) %>% ungroup()
